...
const Tablero = ({jugada, seleccion1, seleccion2, puntuacion}) => {
  return (
    <div id='tableroCartas'>
        ...
        <div id='cartaFron'>
          ...
          return <CartaFrontal carta={carta} key={carta} handleClick={jugada} seleccion1={seleccion1} seleccion2={seleccion2} puntuacion={puntuacion}/>
          })}
        </div>
    </div>
  )
